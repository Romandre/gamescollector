...
export interface Conditions {
	...
	"sm": string
	/** `@media screen and (min-width: 40rem) and (max-width: 51.2475rem)` */
	"smOnly": string
	/** `@media screen and (max-width: 39.9975rem)` */
	"smDown": string
	/** `@media screen and (min-width: 51.25rem)` */
	"md": string
	/** `@media screen and (min-width: 51.25rem) and (max-width: 63.9975rem)` */
	"mdOnly": string
	/** `@media screen and (max-width: 51.2475rem)` */
	"mdDown": string
	...
	/** `@media screen and (min-width: 30rem) and (max-width: 39.9975rem)` */
	"xsToSm": string
	/** `@media screen and (min-width: 30rem) and (max-width: 51.2475rem)` */
	"xsToMd": string
	/** `@media screen and (min-width: 30rem) and (max-width: 63.9975rem)` */
	"xsToLg": string
	/** `@media screen and (min-width: 30rem) and (max-width: 79.9975rem)` */
	"xsToXl": string
	/** `@media screen and (min-width: 30rem) and (max-width: 89.9975rem)` */
	"xsTo2xl": string
	/** `@media screen and (min-width: 40rem) and (max-width: 51.2475rem)` */
	"smToMd": string
	...
	"smToXl": string
	/** `@media screen and (min-width: 40rem) and (max-width: 89.9975rem)` */
	"smTo2xl": string
	/** `@media screen and (min-width: 51.25rem) and (max-width: 63.9975rem)` */
	"mdToLg": string
	/** `@media screen and (min-width: 51.25rem) and (max-width: 79.9975rem)` */
	"mdToXl": string
	/** `@media screen and (min-width: 51.25rem) and (max-width: 89.9975rem)` */
	"mdTo2xl": string
	/** `@media screen and (min-width: 64rem) and (max-width: 79.9975rem)` */
	"lgToXl": string
