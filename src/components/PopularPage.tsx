...
export function PopularPage() {
  const comingSoonQuery = `fields name, first_release_date, cover.*, platforms.*; where first_release_date > ${twoMonthsAgo} & first_release_date < ${timeNow} & hypes > 1; sort hypes desc; limit 500;`;
